...
def _product_runtime_module(path: Path):
    ...
    if raw.get("runtime_revision") == 13:
        from host import product_runtime_v12
        return product_runtime_v12
    ...
    if raw.get("runtime_revision") == 10:
        from host import product_runtime_v9
        return product_runtime_v9
