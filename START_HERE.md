...
| BTN-6/7 | next, owner decisions: standing pagination as Runtime 006 (needs a non-expiring broker + its own grant); lever characterization before any lever action |
