...
- **Open / optional:** Spotify media-key contention, Windows-logon startup, and the cosmetic Host close reason `page_transition` on a service stop. First-frame timeouts: 1/100 streaming opens on this Host, absorbed by backoff.
