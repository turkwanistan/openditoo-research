"""Runtime 012 successor: Runtime 011 with polished Pocket Moss v3 art.

Runtime 011 remains the live rollback baseline. Runtime 012 preserves all Runtime 011 behavior and uses
...
TEMPLATE = ROOT / "product" / "OPENDITOO-PRODUCT-RUNTIME-012.json"
R011_TEMPLATE = ROOT / "product" / "OPENDITOO-PRODUCT-RUNTIME-011.json"
GRANT_TEXT = "Grant OPENDITOO-PRODUCT-RUNTIME-012"
...
HASHED_MODULES = {
    "product_runtime_v6_sha256": ROOT / "host/product_runtime_v6.py",
    ...
    "moss_v3_asset_animations_dance_sha256": ROOT / "assets/pocket_moss/v3/animations/dance.json",
    "moss_v3_asset_animations_idle_look_sha256": ROOT / "assets/pocket_moss/v3/animations/idle-look.json",
    "moss_v3_asset_animations_kisses_sha256": ROOT / "assets/pocket_moss/v3/animations/kisses.json",
    "moss_v3_asset_animations_loaf_sha256": ROOT / "assets/pocket_moss/v3/animations/loaf.json",
    "moss_v3_asset_animations_look_sha256": ROOT / "assets/pocket_moss/v3/animations/look.json",
    "moss_v3_asset_animations_pet_sha256": ROOT / "assets/pocket_moss/v3/animations/pet.json",
    "moss_v3_asset_animations_sleep_wake_sha256": ROOT / "assets/pocket_moss/v3/animations/sleep-wake.json",
    "moss_v3_asset_sprites_dance_crouch_sha256": ROOT / "assets/pocket_moss/v3/sprites/dance_crouch.json",
    "moss_v3_asset_sprites_dance_hop_sha256": ROOT / "assets/pocket_moss/v3/sprites/dance_hop.json",
    "moss_v3_asset_sprites_dance_land_sha256": ROOT / "assets/pocket_moss/v3/sprites/dance_land.json",
    "moss_v3_asset_sprites_dance_left_sha256": ROOT / "assets/pocket_moss/v3/sprites/dance_left.json",
    "moss_v3_asset_sprites_dance_right_sha256": ROOT / "assets/pocket_moss/v3/sprites/dance_right.json",
    "moss_v3_asset_sprites_happy_wag_high_sha256": ROOT / "assets/pocket_moss/v3/sprites/happy_wag_high.json",
    "moss_v3_asset_sprites_happy_wag_low_sha256": ROOT / "assets/pocket_moss/v3/sprites/happy_wag_low.json",
    "moss_v3_asset_sprites_idle_sha256": ROOT / "assets/pocket_moss/v3/sprites/idle.json",
    "moss_v3_asset_sprites_kiss_big_sha256": ROOT / "assets/pocket_moss/v3/sprites/kiss_big.json",
    "moss_v3_asset_sprites_kiss_small_sha256": ROOT / "assets/pocket_moss/v3/sprites/kiss_small.json",
    "moss_v3_asset_sprites_loaf_sha256": ROOT / "assets/pocket_moss/v3/sprites/loaf.json",
    "moss_v3_asset_sprites_look_sha256": ROOT / "assets/pocket_moss/v3/sprites/look.json",
    "moss_v3_asset_sprites_pet_lean_sha256": ROOT / "assets/pocket_moss/v3/sprites/pet_lean.json",
    "moss_v3_asset_sprites_pet_squish_sha256": ROOT / "assets/pocket_moss/v3/sprites/pet_squish.json",
    "moss_v3_asset_sprites_sleep_sha256": ROOT / "assets/pocket_moss/v3/sprites/sleep.json",
    "moss_v3_asset_sprites_wake_sha256": ROOT / "assets/pocket_moss/v3/sprites/wake.json",
}
...
def code_hashes() -> dict[str, str]:
    ...
    # then pin every module and authored asset that can change Runtime 012 pixels, input or pacing.
...
def load_policy(path: Path, *, require_authority: bool = True, verify_hashes: bool = True,
    ...
    try:
        ...
        r011 = json.loads(R011_TEMPLATE.read_text(encoding="utf-8"))
    ...
    _require(raw.get("pages") == PAGES, "PRODUCT_012_PAGES_MISMATCH")
    _require(raw.get("session") == SESSION, "PRODUCT_012_ENVELOPE_MISMATCH")
    for key in ("target", "behavior", "product_id", "install"):
        _require(raw.get(key) == r011[key], "PRODUCT_012_WIDENS_011", key)
    _require((raw.get("pagination") or {}).get("broker") == r011["pagination"]["broker"]
             and (raw.get("build") or {}).get("button_probe_sha256") == r011["build"]["button_probe_sha256"]
             and (raw.get("build") or {}).get("host_dll_sha256") == r011["build"]["host_dll_sha256"],
             "PRODUCT_012_CHANGES_INPUT_OR_HOST")
...
def session_manifest(policy: StandingPolicy, experiment_id: str) -> activity_session.SessionManifest:
    return activity_session.SessionManifest(
        ...
        activation_source="persistent Runtime 012 Pocket Moss interactive product",
