"""Runtime 011 successor: Runtime 010 with readability-revised Pocket Moss v2 art.

Runtime 010 remains the live rollback baseline. Runtime 011 preserves all Runtime 010 behavior and uses
...
TEMPLATE = ROOT / "product" / "OPENDITOO-PRODUCT-RUNTIME-011.json"
R010_TEMPLATE = ROOT / "product" / "OPENDITOO-PRODUCT-RUNTIME-010.json"
GRANT_TEXT = "Grant OPENDITOO-PRODUCT-RUNTIME-011"
...
HASHED_MODULES = {
    "product_runtime_v5_sha256": ROOT / "host/product_runtime_v5.py",
    ...
    "moss_v2_asset_animations_dance_sha256": ROOT / "assets/pocket_moss/v2/animations/dance.json",
    "moss_v2_asset_animations_idle_look_sha256": ROOT / "assets/pocket_moss/v2/animations/idle-look.json",
    "moss_v2_asset_animations_kisses_sha256": ROOT / "assets/pocket_moss/v2/animations/kisses.json",
    "moss_v2_asset_animations_loaf_sha256": ROOT / "assets/pocket_moss/v2/animations/loaf.json",
    "moss_v2_asset_animations_look_sha256": ROOT / "assets/pocket_moss/v2/animations/look.json",
    "moss_v2_asset_animations_pet_sha256": ROOT / "assets/pocket_moss/v2/animations/pet.json",
    "moss_v2_asset_animations_sleep_wake_sha256": ROOT / "assets/pocket_moss/v2/animations/sleep-wake.json",
    "moss_v2_asset_sprites_dance_left_sha256": ROOT / "assets/pocket_moss/v2/sprites/dance_left.json",
    "moss_v2_asset_sprites_dance_right_sha256": ROOT / "assets/pocket_moss/v2/sprites/dance_right.json",
    "moss_v2_asset_sprites_happy_sha256": ROOT / "assets/pocket_moss/v2/sprites/happy.json",
    "moss_v2_asset_sprites_idle_sha256": ROOT / "assets/pocket_moss/v2/sprites/idle.json",
    "moss_v2_asset_sprites_kiss_sha256": ROOT / "assets/pocket_moss/v2/sprites/kiss.json",
    "moss_v2_asset_sprites_loaf_sha256": ROOT / "assets/pocket_moss/v2/sprites/loaf.json",
    "moss_v2_asset_sprites_look_sha256": ROOT / "assets/pocket_moss/v2/sprites/look.json",
    "moss_v2_asset_sprites_pet_lean_sha256": ROOT / "assets/pocket_moss/v2/sprites/pet_lean.json",
    "moss_v2_asset_sprites_sleep_sha256": ROOT / "assets/pocket_moss/v2/sprites/sleep.json",
    "moss_v2_asset_sprites_wake_sha256": ROOT / "assets/pocket_moss/v2/sprites/wake.json",
}
...
def code_hashes() -> dict[str, str]:
    ...
    # then pin every module and authored asset that can change Runtime 011 pixels, input or pacing.
...
def load_policy(path: Path, *, require_authority: bool = True, verify_hashes: bool = True,
    ...
    try:
        ...
        r010 = json.loads(R010_TEMPLATE.read_text(encoding="utf-8"))
    ...
    _require(raw.get("pages") == PAGES, "PRODUCT_011_PAGES_MISMATCH")
    _require(raw.get("session") == SESSION, "PRODUCT_011_ENVELOPE_MISMATCH")
    for key in ("target", "behavior", "product_id", "install"):
        _require(raw.get(key) == r010[key], "PRODUCT_011_WIDENS_010", key)
    _require((raw.get("pagination") or {}).get("broker") == r010["pagination"]["broker"]
             and (raw.get("build") or {}).get("button_probe_sha256") == r010["build"]["button_probe_sha256"]
             and (raw.get("build") or {}).get("host_dll_sha256") == r010["build"]["host_dll_sha256"],
             "PRODUCT_011_CHANGES_INPUT_OR_HOST")
...
def session_manifest(policy: StandingPolicy, experiment_id: str) -> activity_session.SessionManifest:
    return activity_session.SessionManifest(
        ...
        activation_source="persistent Runtime 011 Pocket Moss interactive product",
