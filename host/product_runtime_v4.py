"""Runtime 010 successor: Runtime 009 plus Pocket Moss and generic modal navigation.

Runtime 009 remains the live rollback baseline. Runtime 010 adds a third page, Pocket Moss, using
...
TEMPLATE = ROOT / "product" / "OPENDITOO-PRODUCT-RUNTIME-010.json"
R009_TEMPLATE = ROOT / "product" / "OPENDITOO-PRODUCT-RUNTIME-009.json"
GRANT_TEXT = "Grant OPENDITOO-PRODUCT-RUNTIME-010"
...
HASHED_MODULES = {
    "product_runtime_v4_sha256": ROOT / "host/product_runtime_v4.py",
    ...
    "moss_asset_animations_dance_sha256": ROOT / "assets/pocket_moss/v1/animations/dance.json",
    "moss_asset_animations_idle_look_sha256": ROOT / "assets/pocket_moss/v1/animations/idle-look.json",
    "moss_asset_animations_kisses_sha256": ROOT / "assets/pocket_moss/v1/animations/kisses.json",
    "moss_asset_animations_loaf_sha256": ROOT / "assets/pocket_moss/v1/animations/loaf.json",
    "moss_asset_animations_look_sha256": ROOT / "assets/pocket_moss/v1/animations/look.json",
    "moss_asset_animations_pet_sha256": ROOT / "assets/pocket_moss/v1/animations/pet.json",
    "moss_asset_animations_sleep_wake_sha256": ROOT / "assets/pocket_moss/v1/animations/sleep-wake.json",
    "moss_asset_sprites_dance_left_sha256": ROOT / "assets/pocket_moss/v1/sprites/dance_left.json",
    "moss_asset_sprites_dance_right_sha256": ROOT / "assets/pocket_moss/v1/sprites/dance_right.json",
    "moss_asset_sprites_happy_sha256": ROOT / "assets/pocket_moss/v1/sprites/happy.json",
    "moss_asset_sprites_idle_sha256": ROOT / "assets/pocket_moss/v1/sprites/idle.json",
    "moss_asset_sprites_kiss_sha256": ROOT / "assets/pocket_moss/v1/sprites/kiss.json",
    "moss_asset_sprites_loaf_sha256": ROOT / "assets/pocket_moss/v1/sprites/loaf.json",
    "moss_asset_sprites_look_sha256": ROOT / "assets/pocket_moss/v1/sprites/look.json",
    "moss_asset_sprites_pet_lean_sha256": ROOT / "assets/pocket_moss/v1/sprites/pet_lean.json",
    "moss_asset_sprites_sleep_sha256": ROOT / "assets/pocket_moss/v1/sprites/sleep.json",
    "moss_asset_sprites_wake_sha256": ROOT / "assets/pocket_moss/v1/sprites/wake.json",
}
...
def code_hashes() -> dict[str, str]:
    ...
    # then pin every module and authored asset that can change Runtime 010 pixels, input or pacing.
...
def load_policy(path: Path, *, require_authority: bool = True, verify_hashes: bool = True,
    ...
    try:
        ...
        r009 = json.loads(R009_TEMPLATE.read_text(encoding="utf-8"))
    ...
    _require(raw.get("pages") == PAGES, "PRODUCT_010_PAGES_MISMATCH")
    _require(raw.get("session") == SESSION, "PRODUCT_010_ENVELOPE_MISMATCH")
    for key in ("target", "behavior", "product_id", "install"):
        _require(raw.get(key) == r009[key], "PRODUCT_010_WIDENS_009", key)
    _require((raw.get("pagination") or {}).get("broker") == r009["pagination"]["broker"]
             and (raw.get("build") or {}).get("button_probe_sha256") == r009["build"]["button_probe_sha256"]
             and (raw.get("build") or {}).get("host_dll_sha256") == r009["build"]["host_dll_sha256"],
             "PRODUCT_010_CHANGES_INPUT_OR_HOST")
...
def session_manifest(policy: StandingPolicy, experiment_id: str) -> activity_session.SessionManifest:
    return activity_session.SessionManifest(
        ...
        activation_source="persistent Runtime 010 Pocket Moss interactive product",
