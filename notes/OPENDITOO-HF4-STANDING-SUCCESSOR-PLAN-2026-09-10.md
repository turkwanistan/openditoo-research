...
**Status:** plan only. Nothing is built; no authority. HF-3 is PASS (`OPENDITOO-INTERACTIVE-HF3-008`, see `notes/OPENDITOO-HANDOFF-2026-09-10-HF3.md`). Live product: Runtime 007 + webcam 006 on Host `3faf520f…`. Runtime 007 is the rollback target.
