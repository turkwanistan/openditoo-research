...
Write-Output 'W9B_OPTICAL_WINDOWS_LAUNCH_BEGIN experiment_id=OPENDITOO-WEBCAM-N980P-006'
...
& wsl.exe -d $Distro -- bash ($WslRepositoryPath + '/scripts/run_webcam_w9b_optical_once.sh')
$rc=$LASTEXITCODE
