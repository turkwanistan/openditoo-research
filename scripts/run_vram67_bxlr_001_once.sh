...
FIXTURE_REPORT=artifacts/analysis/volatile_ram_api_vram67_fixture.json
...
LOCAL_DIR=.openditoo-local/vram67-bxlr-001
...
python3 tools/ditoo_vram67_live_gate.py --selfcheck >/dev/null
...
checks=[
 ...
 d.get('experiment_id')=='OPENDITOO-VRAM67-BXLR-001',
...
assert m['experiment_id']=='OPENDITOO-VRAM67-BXLR-001'
...
PS1="$(wslpath -w "$ROOT/runtime/windows/run_openditoo_vram67_bxlr_001_once.ps1")"
set +e
