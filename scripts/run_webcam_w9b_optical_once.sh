...
MANIFEST="experiments/DAY1-WEBCAM-N980P-006.json"
RESULT_FILE="captures/OPENDITOO-WEBCAM-W9B-006-LIVE-RESULT-2026-09-10.json"
RAW_FILE="captures/OPENDITOO-WEBCAM-W9B-006-LIVE-RAW-2026-09-10.log"
...
echo 'W9B_BEGIN experiment_id=OPENDITOO-WEBCAM-N980P-006 lifetime_seconds=10 client_floor_ms=50 host_floor_ms=40 margin_ms=10 max_frames=201 max_packets=603 max_tx_bytes=211854'
python3 scripts/verify_day1_offline.py
python3 scripts/check_webcam_w9b_optical.py
python3 - <<'PY'
from pathlib import Path
from host import frame_stream
p=Path('experiments/DAY1-WEBCAM-N980P-006.json'); blockers=frame_stream.authority_blockers(p)
...
assert m.experiment_id=='OPENDITOO-WEBCAM-N980P-006'
...
if d.get('experiment_id')!='OPENDITOO-WEBCAM-N980P-006': raise SystemExit('W9B_RESULT_ID_MISMATCH')
