...
MANIFEST="experiments/DAY1-WEBCAM-W10-001.json"
RESULT_FILE="captures/OPENDITOO-WEBCAM-W10-001-LIVE-RESULT-2026-09-10.json"
RAW_FILE="captures/OPENDITOO-WEBCAM-W10-001-LIVE-RAW-2026-09-10.log"
...
echo 'W10_BEGIN experiment_id=OPENDITOO-WEBCAM-W10-001 lifetime_seconds=60 slot_ms=50 client_floor_ms=50 host_floor_ms=40 max_frames=500 max_packets=1500 max_tx_bytes=527000'
...
p=Path('experiments/DAY1-WEBCAM-W10-001.json'); blockers=frame_stream.authority_blockers(p)
...
assert m.experiment_id=='OPENDITOO-WEBCAM-W10-001'
...
if d.get('experiment_id')!='OPENDITOO-WEBCAM-W10-001': raise SystemExit('W10_RESULT_ID_MISMATCH')
