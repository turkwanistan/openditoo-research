...
{
    internal const string ExperimentId = "OPENDITOO-VRAM8B-CANARY-003";
    internal const string RequiredGrantText = "Grant OPENDITOO-VRAM8B-CANARY-003 -- stock btplayer selected";
    ...
    internal const string ManifestSha256 = "adcf33e0883bbb2885715f8a4a86a23c0fc101ca4b6304c0e5f20e2366ef03a0";
    internal const string FixtureReportSha256 = "ebdb4be66725c15435d7ed0d24466ba06fb53b2225005d6e2cd13d25cf82161a";
    ...
    [
        new("baseline_set", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-01-baseline-set.bin", "3f98ef3e2af07ccd2151bd06ae96ad8bdfc82d8fb1ed94c0f66d3580ae75ca47", 8, false, null, false),
        new("baseline_get", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-02-baseline-get.bin", "6fe20a0815b73bb62acf228634f664379efae9983842eeca6ac7974c2f2bea7c", 7, true, 0, false),
        new("prime", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-03-prime.bin", "9f643ace4ce755ddcd04446c0cb21bbaa23b53f123788a225d1c9eda81e213ec", 8, false, null, false),
        new("voicetip", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-04-voicetip.bin", "4cf9f3d0458664a2c99681e6a672b8eaefea3a043d83a2f15a751aabcd9d0316", 10, false, null, false),
        new("overwrite", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-05-overwrite.bin", "298f1901ea9cc94fd172302117cd2e5cf411eacb578b16be5de3ecf1c52e0906", 1099, false, null, true),
        new("post_get", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-06-post-get.bin", "6fe20a0815b73bb62acf228634f664379efae9983842eeca6ac7974c2f2bea7c", 7, true, 1, false),
        new("restore_set", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-07-restore-set.bin", "3f98ef3e2af07ccd2151bd06ae96ad8bdfc82d8fb1ed94c0f66d3580ae75ca47", 8, false, null, false),
        new("restore_get", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-003-08-restore-get.bin", "6fe20a0815b73bb62acf228634f664379efae9983842eeca6ac7974c2f2bea7c", 7, true, 0, false),
    ];
    ...
    {
        var manifestPath = Path.Combine(repoRoot, "experiments", "OPENDITOO-VRAM8B-CANARY-003.json");
        var fixtureReportPath = Path.Combine(repoRoot, "artifacts", "analysis", "volatile_ram_api_vram8b_fixture_003.json");
