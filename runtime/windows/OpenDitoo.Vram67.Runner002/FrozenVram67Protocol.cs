...
{
    internal const string ExperimentId = "OPENDITOO-VRAM67-BXLR-002";
    internal const string RequiredGrantText = "Grant OPENDITOO-VRAM67-BXLR-002 -- stock btplayer selected";
