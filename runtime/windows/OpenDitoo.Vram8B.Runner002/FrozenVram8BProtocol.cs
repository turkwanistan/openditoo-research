...
{
    internal const string ExperimentId = "OPENDITOO-VRAM8B-CANARY-002";
    internal const string RequiredGrantText = "Grant OPENDITOO-VRAM8B-CANARY-002 -- stock btplayer selected";
    ...
    internal const string ManifestSha256 = "0f054872b6886a6eacea9ae71ab43f01ef393d1cf55e4e242535f73d6a1cc758";
    internal const string FixtureReportSha256 = "6b87fe811a22614654bcb0fb30fd8ffcaa84442ef73291a7af4925920dc0fd9a";
    ...
    [
        new("baseline_set", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-01-baseline-set.bin", "3f98ef3e2af07ccd2151bd06ae96ad8bdfc82d8fb1ed94c0f66d3580ae75ca47", 8, false, null, false),
        new("baseline_get", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-02-baseline-get.bin", "6fe20a0815b73bb62acf228634f664379efae9983842eeca6ac7974c2f2bea7c", 7, true, 0, false),
        new("prime", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-03-prime.bin", "9f643ace4ce755ddcd04446c0cb21bbaa23b53f123788a225d1c9eda81e213ec", 8, false, null, false),
        new("voicetip", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-04-voicetip.bin", "4cf9f3d0458664a2c99681e6a672b8eaefea3a043d83a2f15a751aabcd9d0316", 10, false, null, false),
        new("overwrite", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-05-overwrite.bin", "298f1901ea9cc94fd172302117cd2e5cf411eacb578b16be5de3ecf1c52e0906", 1099, false, null, true),
        new("post_get", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-06-post-get.bin", "6fe20a0815b73bb62acf228634f664379efae9983842eeca6ac7974c2f2bea7c", 7, true, 1, false),
        new("restore_set", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-07-restore-set.bin", "3f98ef3e2af07ccd2151bd06ae96ad8bdfc82d8fb1ed94c0f66d3580ae75ca47", 8, false, null, false),
        new("restore_get", "experiments/fixtures/OPENDITOO-VRAM8B-CANARY-002-08-restore-get.bin", "6fe20a0815b73bb62acf228634f664379efae9983842eeca6ac7974c2f2bea7c", 7, true, 0, false),
    ];
    ...
    {
        var manifestPath = Path.Combine(repoRoot, "experiments", "OPENDITOO-VRAM8B-CANARY-002.json");
        var fixtureReportPath = Path.Combine(repoRoot, "artifacts", "analysis", "volatile_ram_api_vram8b_fixture_002.json");
