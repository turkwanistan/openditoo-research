...
$Project = Join-Path $RepoRoot 'runtime\windows\OpenDitoo.Vram67.Runner002\OpenDitoo.Vram67.Runner002.csproj'
$Dotnet = (Get-Command dotnet.exe -ErrorAction Stop).Source

Write-Host 'VRAM67_EXECUTION_ID=OPENDITOO-VRAM67-BXLR-002'
