...
$Project = Join-Path $RepoRoot 'runtime\windows\OpenDitoo.Vram8B.Runner002\OpenDitoo.Vram8B.Runner002.csproj'
$Dotnet = (Get-Command dotnet.exe -ErrorAction Stop).Source
Write-Host 'VRAM8B_EXECUTION_ID=OPENDITOO-VRAM8B-CANARY-002'
