...
var manifestPath = Path.Combine(repoRoot, "experiments", "OPENDITOO-VRAM67-BXLR-001.json");
var fixturePath = Path.Combine(repoRoot, "artifacts", "analysis", "volatile_ram_api_vram67_fixture.json");
var localDir = Path.Combine(repoRoot, ".openditoo-local", "vram67-bxlr-001");
...
try
{
    ...
    Console.WriteLine("VRAM67_CUSTOM_0X6C_SENDS=1");
