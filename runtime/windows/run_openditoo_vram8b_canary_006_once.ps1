...
$Project = Join-Path $RepoRoot 'runtime\windows\OpenDitoo.Vram8B.Runner006\OpenDitoo.Vram8B.Runner006.csproj'
$Dotnet = (Get-Command dotnet.exe -ErrorAction Stop).Source
Write-Host 'VRAM8B_EXECUTION_ID=OPENDITOO-VRAM8B-CANARY-006'
